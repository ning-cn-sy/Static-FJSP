...
from TSPProblem1 import TSPProblem
from draw import draw
# from aaa import aaaA
from testMutation import testMutation

# 日志,不用管
logger = get_logger(__name__)
# 读坐标文件
data = np.loadtxt(open("zuobiao.csv", "rb"), delimiter=",", skiprows=0, usecols=[0, 1])
# 定义Problem,要传参,传坐标
problem = TSPProblem(len(data), zuobiao=data)
# 一些算法参数
population_size = 100
