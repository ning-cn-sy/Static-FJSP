...
from jmetal.core.solution import PermutationSolution, S, CompositeSolution
...
class TSPProblem(PermutationProblem):
    ...
    def evaluate(self, solution: PermutationProblem) -> PermutationProblem:
    ...
    def create_solution(self) -> S:
        ...
        # solutionlist = [new_solution,new_solution]
        # new_solution = PermutationProblem(solutions=solutionlist)
