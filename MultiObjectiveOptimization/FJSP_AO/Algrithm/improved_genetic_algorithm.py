# -*- coding: utf-8 -*-
# @Time    : 2025/4/15 15:06
# @Author  : 宁诗铎
# @Site    : 
# @File    : improved_genetic_algorithm.py
# @Software: PyCharm 
# @Comment : 改进遗传算法
...
class improved_genetic_algorithm(EvolutionaryAlgorithm[S, R]):
    def __init__(
            self,
            problem: Problem,
            population_size: int,
        ...
        super(improved_genetic_algorithm, self).__init__(
