...
def A_name(name1, name2):
    return f"A{name1, name2}"
...
def D_name(name1, name2):
    return f"D{name1, name2}"
...
def Z_name(name1, name2, name3, name4, name5):
    return f"Z{name1, name2, name3, name4, name5}"
...
def constraint_name_ass(name1, name2, name3):
    # 约束11、12 name8不一样 约束11 的name8是q'  约束12 k'
    ret = "C" + str(name1) + "-g" + str(name2) + "-s" + str(name3)
    return ret
